...
public class Synchronizer4 extends Thread {
    ...
    public Synchronizer4(int start, int id, int size, boolean synchronizer) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        int id = 0;
        int indexStart = 0;
        Synchronizer4 synchronizer = new Synchronizer4(indexStart, id++, size, true);
        threads.add(synchronizer);
        for (int i = 0; i < threadsCount; i++) {

            Synchronizer4 synchronizer4 = new Synchronizer4(indexStart, id++, size, false);
